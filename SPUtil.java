package com.hisense.pos.xwpos.util;
...
import com.hisense.pos.xwpos.SharedApplication;
...
public class SPUtil {
    ...
    public static SharedPreferences getSharePreferences(String preName){
        if(TextUtils.isEmpty(preName)){
            return  PreferenceManager.getDefaultSharedPreferences(SharedApplication.context);
        }else {
           return  SharedApplication.context.getSharedPreferences(preName,Context.MODE_PRIVATE);
        }
    }
